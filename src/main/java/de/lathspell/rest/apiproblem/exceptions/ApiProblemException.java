package de.lathspell.rest.apiproblem.exceptions;
...
public class ApiProblemException extends WebApplicationException {
    ...
    public final static MediaType APPLICATION_PROBLEM_JSON_TYPE = MediaType.valueOf(APPLICATION_PROBLEM_JSON);
    ...
    public ApiProblemException(ApiProblem ap) {
        this.ap = ap;
    }
    ...
    public Response getResponse() {
        ...
        return Response.status(ap.getHttpStatus()).type(APPLICATION_PROBLEM_JSON).entity(ap).build();
    }
